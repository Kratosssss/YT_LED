...
public class MarqueeView  extends SurfaceView implements SurfaceHolder.Callback{
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, com.dalong.marqueeview.R.styleable.MarqueeView, defStyleAttr, 0);
        mTextColor = a.getColor(com.dalong.marqueeview.R.styleable.MarqueeView_textcolor, Color.RED);
        mTextSize = a.getDimension(com.dalong.marqueeview.R.styleable.MarqueeView_textSize, 48);
        mBackgroundColor=a.getColor(com.dalong.marqueeview.R.styleable.MarqueeView_marqueebackground,Color.BLACK);
        mIsRepeat=a.getBoolean(com.dalong.marqueeview.R.styleable.MarqueeView_isRepeat,false);
        mStartPoint=a.getInt(com.dalong.marqueeview.R.styleable.MarqueeView_startPoint,0);
        mDirection=a.getInt(com.dalong.marqueeview.R.styleable.MarqueeView_direction,0);
        mSpeed=a.getInt(com.dalong.marqueeview.R.styleable.MarqueeView_speed,20);
        a.recycle();
    ...
    public void setmTextSize(float msg){
        mTextSize = msg;
    }
...
//        mTextPaint.setShadowLayer(5, 3, 3, ShadowColor);
    ...
    com.dalong.marqueeview.MarqueeView.OnMargueeListener mOnMargueeListener;

    public void setOnMargueeListener(com.dalong.marqueeview.MarqueeView.OnMargueeListener mOnMargueeListener){
